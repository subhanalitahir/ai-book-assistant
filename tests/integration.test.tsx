...
jest.mock('@vapi-ai/web', () => jest.fn().mockImplementation(() => ({ start: mockStart, stop: mockStop })));

jest.mock('@/lib/actions/session.actions', () => ({ startVoiceSession: jest.fn() }));
...
describe('Integration: Book context + Voice session', () => {
  ...
  it('starts Vapi when book context exists and book._id provided', async () => {
    ...
    const fullBook = { _id: 'book_99', title: 'Uploaded Book', author: 'Author', coverURL: '' } as any;
